      ...
      <div class="production-timeline">
          <div v-for="log in statusHistory" :key="log.id" class="p-log-item">
              ...
              <div class="p-log-content">
                  ...
                  <p class="p-log-meta">{{ t('Changed by', 'تم التغيير بواسطة') }} {{ log.changer?.name }}</p>
              </div>
          </div>
...
.detail-item span { color: #64748b; font-weight: 500; }
.detail-item strong { color: #1e293b; font-weight: 700; }
