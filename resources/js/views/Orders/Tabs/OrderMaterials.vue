<template>
  <div class="tab-pane animate-fade-in">
          ...
          <tbody>
            ...
            <tr v-if="!order.materials || order.materials.length === 0">
              <td colspan="5" class="text-muted py-4 text-center">
                {{ t('No materials records found', 'لا توجد سجلات مواد') }}
              </td>
            </tr>
    ...
    <div class="compact-grid mt-1">
      ...
      <BaseCard :title="t('Fabric Specifications', 'مواصفات القماش')" class="compact-card">
        <div class="info-item-grid-2">
          ...
          <div class="info-field">
            ...
            <span class="value">{{
              order.fabric_details?.gsm || order.fabric_details?.weight
                ? (order.fabric_details.gsm || order.fabric_details.weight) + ' gsm'
                : '---'
            }}</span>
          </div>
          <div class="info-field">
          ...
          <div class="info-field">
            ...
            <span class="value">{{
              order.fabric_details?.supplier || form.fabric_supplier || '---'
            }}</span>
          </div>
          <div class="info-field">
      ...
      <BaseCard
        :title="t('Trim & Branding Details', 'تفاصيل الإضافات والهوية')"
        class="compact-card"
      >
