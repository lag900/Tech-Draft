      ...
      <div class="profile-grid">
        ...
        <div class="profile-main">
          <BaseCard class="profile-section" :title="t('General Information', 'المعلومات العامة')">
            ...
            <template #footer>
              <div class="flex justify-end">
                <BaseButton :loading="loading" @click="saveProfile">{{
          ...
          <BaseCard class="profile-section mt-2" :title="t('Security', 'الأمان')">
            ...
            <template #footer>
              <div class="flex justify-end">
                <BaseButton variant="white" :loading="passLoading" @click="changePassword">{{
        ...
        <div class="profile-side">
          ...
          <BaseCard class="help-card mt-1">
            ...
            <p>
              {{
                t(
                  'Contact our support team for any issues with your account.',
                  'تواصل مع فريق الدعم لأي مشكلة في حسابك.'
                )
              }}
            </p>
            <BaseButton variant="ghost" size="sm" class="mt-1">{{
