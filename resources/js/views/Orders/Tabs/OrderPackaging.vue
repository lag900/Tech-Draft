<template>
  <div class="tab-pane animate-fade-in">
    <div class="tech-spec-grid">
      <!-- 1. Labeling & Branding -->
      <BaseCard
        :title="t('Labeling & Placement', 'بطاقات البيانات والوضع المرجعي')"
        class="spec-card"
      >
        <div class="info-grid-2">
          ...
          <div class="info-field">
            ...
            <span class="value">{{
              order.production_details?.label_position || 'Center Back Neck'
            }}</span>
          </div>
        </div>
      </BaseCard>
    ...
    <BaseCard :title="t('Packaging Instruction Details', 'تفاصيل تعليمات التغليف')" class="mt-1">
      <div class="packaging-instruction-box">
        ...
        >
          <path
            d="M21 8V5a2 2 0 00-2-2H5a2 2 0 00-2 2v3m18 0l-9 6-9-6m18 0v11a2 2 0 01-2 2H5a2 2 0 01-2-2V8"
          />
        </svg>
        <p>
          {{
            ...
            t(
              'Standard export packaging. Corrugated cartons. No moisture allowed.',
              'تغليف قياسي للتصدير. كراتين مضلعة. غير مسموح بالرطوبة.'
            )
          }}
        </p>
      </div>
