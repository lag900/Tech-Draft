<template>
  <div class="tech-pack-print-wrapper" v-if="order">
    ...
    <div class="tp-page">
      ...
      <div class="tp-grid-2">
        <div class="col-stack">
          <ConstructionSpecs 
            :stitchType="construction.stitch_type"
            :seamType="construction.seam_type"
            :spi="construction.spi"
            :threadType="construction.thread_type"
      ...
      <div class="tp-grid-2 mt-10">
        <div class="col-stack">
          ...
          />
          <PackagingShipping 
            :packType="packaging.packaging_type"
            :foldingMethod="packaging.folding_method"
            :cartonQty="packaging.carton_qty"
            :barcodeRequired="packaging.barcode_required"
          />
        </div>
        <div class="col-stack">
          <LabelingPlacement 
            :mainLabel="packaging.labels.main"
            :sizeLabel="packaging.labels.size"
            :careLabel="packaging.labels.care"
...
const production = computed(() => unified.value.production || { operations: [], anatomy: [], marker: {} });
...
.tp-page * { font-size: 11px; line-height: 1.4; }
.tp-page b, .tp-page strong { font-weight: 800; }

@media print {
  body {
    background: white;
  }
  .tech-pack-print-wrapper { background: white !important; padding: 0 !important; display: block; gap: 0 !important; margin: 0 !important; }
  .tp-page { 
