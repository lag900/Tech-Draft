<template>
  <div
    ...
    :class="{ 'is-open': isOpen, 'is-rtl': isRtl }"
  >
    ...
    <div v-if="$slots.help" class="help-text-slot">
      <slot name="help" />
    </div>
      ...
      <Transition name="dropdown-fade">
        ...
        >
          ...
          <div ref="optionsListRef" class="options-list">
            ...
            <div
              v-else-if="allowCustom && searchQuery"
              class="option-item custom-entry"
              @click="selectCustom"
            >
              <span class="option-label"
                >{{ t('Use custom:', 'استخدم مخصص:') }} "{{ searchQuery }}"</span
              >
            </div>
            <div v-else class="no-results">
              {{
                searchQuery
                  ...
                  : noResultsMessage || t('No options available', 'لا توجد خيارات متاحة')
              }}
            </div>
          </div>
        </div>
