  ...
  <div class="auth-page" :class="{ rtl: isRtl }">
    <div class="auth-card">
      ...
      <p>
        {{
          t(
            'Log in to manage your manufacturing orders',
            'قم بتسجيل الدخول لإدارة طلبات التصنيع الخاصة بك'
          )
        }}
      </p>
  ...
  const login = async () => {
    ...
    try {
      ...
      error.value =
        ...
        t('Invalid email or password', 'البريد الإلكتروني أو كلمة المرور غلط');
    } finally {
      loading.value = false;
    }
  };
