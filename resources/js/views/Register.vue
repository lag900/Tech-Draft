  ...
  <div class="auth-page px-1" :class="{ rtl: isRtl }">
    <div class="auth-card" :class="{ 'client-wide': form?.role === 'client' }">
      ...
      <form @submit.prevent="register">
            ...
            <div class="form-grid-2">
              <div class="form-group">
                ...
                <input
                  ...
                  type="text"
                  required
                  :placeholder="t('Ex: John Doe', 'مثال: أحمد محمد')"
                />
              </div>
              <div class="form-group">
                ...
                <input
                  ...
                  type="text"
                  required
                  :placeholder="t('Brand Name', 'اسم البراند')"
                />
              </div>
              <div class="form-group">
                ...
                <input
                  ...
                  type="text"
                  :placeholder="
                    t('Official company name (Optional)', 'اسم الشركة الرسمي (اختياري)')
                  "
                />
              </div>
              <div class="form-group">
        ...
        <button type="submit" class="primary-btn btn-lg mt-3 w-full" :disabled="loading">
