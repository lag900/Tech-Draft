...
.status-label.draft { background: #fee2e2; color: #991b1b; }
.status-label.approved { background: #dcfce7; color: #166534; }
.status-label.production { background: #e0e7ff; color: #3730a3; }
</style>
