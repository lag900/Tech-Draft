...
export const ROLE_PERMISSIONS = {
  ...
  [ROLES.ADMIN]: ALL_PERMISSIONS.filter(p => !p.includes('settings.delete') && !p.includes('roles.delete')),
  [ROLES.MANAGER]: [
    'dashboard.view',
    'orders.view', 'orders.edit', 'orders.approve', 'orders.export',
    'fabrics.view', 'fabrics.edit',
    'designs.view', 'designs.edit',
    'categories.view', 'item_types.view', 'fit_types.view',
    'clients.view',
    'team.view'
  ],
  [ROLES.DESIGNER]: [
    ...
    'designs.create', 'designs.view', 'designs.edit', 'designs.delete',
    'fabrics.view',
  ...
  [ROLES.DATA_ENTRY]: [
    ...
    'fabrics.create', 'fabrics.view', 'fabrics.edit',
    'designs.create', 'designs.view', 'designs.edit',
    'categories.create', 'categories.view',
    'item_types.create', 'item_types.view',
    'fit_types.create', 'fit_types.view'
  ],
  [ROLES.CLIENT]: [
    'dashboard.view',
    'orders.create', 'orders.view', 'orders.edit',
    'designs.view', 'designs.create',
    'products.view',
    'categories.view', 'item_types.view', 'fit_types.view', 'fabrics.view'
  ]
};
